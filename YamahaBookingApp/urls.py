...
from .views import  RecoveryDataRecive, Location, FormValidation, UserRegistration, OTPCheck, LoginCheck, DepositBank, AllProductInfo, BookingSave, AccountDetail, AllBooking, AllProductForMessage, BookingQueryCheck, MessageSave, UserAccountUpdate, BookingEdit, InboxInfoDetail, BookingUpdate, DownloadPaySlip,ForgetPassword, StocknRemainingdays, AllDealerLocation, NotificationControll, PiImageSave, MyAppCustomer,LocationTrackerLoginCheck, Myrabbitmq, UserPathByDate, MayaDataProvider, RecoveryOfficerCollection,RecoveryOfficerLogin, PumpCollection, MotorService
...
router.register(r'recoveryofficerlogin', RecoveryOfficerLogin)
router.register(r'recoveryofficercollection', RecoveryOfficerCollection)
router.register(r'motorservices', MotorService)
router.register(r'pumpcollection', PumpCollection)
