...
from .views import  RecoveryDataRecive, Location, FormValidation, UserRegistration, OTPCheck, LoginCheck, DepositBank, AllProductInfo, BookingSave, AccountDetail, AllBooking, AllProductForMessage, BookingQueryCheck, MessageSave, UserAccountUpdate, BookingEdit, InboxInfoDetail, BookingUpdate, DownloadPaySlip, ForgetPassword, StocknRemainingdays, AllDealerLocation, NotificationControll, PiImageSave, MyAppCustomer, LocationTrackerLoginCheck, Myrabbitmq
